...
public class OrderAlertIPhoneConsumer extends BaseAlertConsumer implements
		MessageListener {
	...
	private final static Logger logger = Logger.getLogger(OrderAlertIPhoneConsumer.class);
