package com.phillip.services.notification.service;
...
import com.phillip.services.notification.error.JacksonUtilityException;
import com.phillip.services.notification.models.FirebaseResponse;
import com.phillip.services.notification.util.JacksonUtility;
...
///////////////////////////////////////////////////////////////////////////////
	 ...
	 * @throws {@link FirebaseException}
	 */
	public FirebaseResponse post( String jsonData, String serverKey ) throws FirebaseException, UnsupportedEncodingException {
		return this.post( null, jsonData , serverKey);
	}
	 ...
	 * @throws {@link FirebaseException}
	 */
	public FirebaseResponse post( String path, String jsonData, String serverKey ) throws FirebaseException, UnsupportedEncodingException {
...
//			LOGGER.error( msg );
	...
	private String buildFullUrlFromRelativePath( String path ) throws UnsupportedEncodingException {
		...
		url = ("".equals(path))? this.baseUrl : this.baseUrl + path + Firebase.FIREBASE_API_JSON_EXTENSION;
...
//				LOGGER.error( msg );
		...
		try {
			if (success) {
				...
				body.put(writer.toString(), writer.toString());
			}
